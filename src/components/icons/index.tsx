...
/**
 * Properti standar untuk semua ikon SVG di GeoPatriot Web.
 */
...
/**
 * Ikon Putar/Beralih Kamera (Depan/Belakang).
 */
export function FlipCameraIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Galeri / Koleksi Foto Sesi.
 */
export function ImagesIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Muat Ulang / Coba Lagi / Spinner.
 */
export function RefreshCwIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Target / Bidik Lokasi GPS (Crosshair).
 */
...
/**
 * Ikon Slider / Konfigurasi Parameter (Sliders).
 */
export function SlidersIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Ikon Arsip / ZIP.
 */
export function ArchiveIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Kotak Centang Aktif (CheckSquare).
 */
export function CheckSquareIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Kotak Kosong (Square).
 */
export function SquareIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Masuk Layar Penuh (Maximize/Expand).
 */
export function MaximizeIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Ikon Keluar Layar Penuh (Minimize/Collapse).
 */
export function MinimizeIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
